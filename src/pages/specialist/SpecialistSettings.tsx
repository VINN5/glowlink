...
const SpecialistSettings = () => {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      {/* Profile */}
      <div className="bg-white rounded-2xl border border-purple-50 shadow-sm overflow-hidden mb-4">
        <div className="p-5 border-b border-gray-50">
          <h2 className="font-bold text-gray-800 text-sm flex items-center gap-2">
            <User className="w-4 h-4 text-violet-400" /> Account Information
          </h2>
        </div>
        ...
        <div className="p-5 border-b border-gray-50 flex items-center gap-4">
          ...
          <div>
            ...
            <span className="inline-block mt-1 text-xs bg-violet-50 text-violet-600 px-2.5 py-0.5 rounded-full font-medium">
              Specialist
            </span>
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex items-center gap-2 bg-violet-500 hover:bg-violet-600 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors disabled:opacity-60 shadow-sm"
          >
      ...
      <div className="bg-white rounded-2xl border border-purple-50 shadow-sm p-5">
        <h2 className="font-bold text-gray-800 text-sm flex items-center gap-2 mb-4">
          <Shield className="w-4 h-4 text-violet-400" /> Account Security
        </h2>
