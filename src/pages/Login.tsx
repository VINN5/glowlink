...
const redirectByRole = (role: string, navigate: Function) => {
...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    sessionStorage.setItem('google_role', 'client');
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-pink-100 p-8">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link to="/register" className="text-pink-500 font-medium hover:text-pink-600">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
